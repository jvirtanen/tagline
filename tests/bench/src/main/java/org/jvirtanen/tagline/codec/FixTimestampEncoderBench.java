...
public class FixTimestampEncoderBench extends Bench {
    ...
    public ByteBuf encodeSecond() {
        ...
        FixTimestampEncoder.encode(timestamp, WITH_SECONDS, buffer);
    ...
    public ByteBuf encodeMilli() {
        ...
        FixTimestampEncoder.encode(timestamp, WITH_MILLISECONDS, buffer);
